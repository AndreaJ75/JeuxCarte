...
public class CreatureTypeCarte extends Carte {
    private String name;
    private Integer damagePointsNbr;
    private Integer lifePointNbr;

    public CreatureTypeCarte(CardType cardType, Integer cost, String name, Integer damagePointsNbr, Integer lifePointNbr){
        super(cardType, cost);
        this.name = name;
